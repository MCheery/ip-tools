...
const CASES: Array<[string, string]> = [
  ...
  ['2001:db8::0', '2001:0db8:0000:0000:0000:0000:0000:0000'],
...
describe('decompressIPv6', (it) => {
  it('should decompress IPv6 address correctly', ({ expect }) => {
    CASES.forEach(([input, output]) => {
      expect(decompressIPv6(input)).toBe(output)
    })
  })
})